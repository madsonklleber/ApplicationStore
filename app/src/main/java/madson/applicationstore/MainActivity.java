package madson.applicationstore;
        ...
        btnInserir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http:www.madsonklleber.com.br/applicationstore/create.php").newBuilder();
        ...
        btnSelecionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http:www.madsonklleber.com.br/applicationstore/read.php").newBuilder();
        ...
        btnAlterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http:www.madsonklleber.com.br/applicationstore/update.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
                    urlBuilder.addQueryParameter("P_Nome", txtPNome.getText().toString());
                    urlBuilder.addQueryParameter("P_Preco", txtPreco.getText().toString());
        ...
        btnExcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http:www.madsonklleber.com.br/applicationstore/delete.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
                    String url = urlBuilder.build().toString();
                    Request request = new Request.Builder()
                            .url(url)
